      ...
      return this.each(function(){
          ...
          $.getJSON(url,function(data){
              ...
              $.each(data.items, function(index,item){
                  ...
                  // Create the html
                  html  = '<li>';
                  html += '<div style="display: flex;" id="video_card">';
                  html += '<img src="'+thumb_url+'" alt="'+title+'" style="margin: 1rem; max-width: 35%;" />';
                  html += '<a title="'+title+'" href="'+video_url+'" data-youtubeID="'+video_id+'" style="margin: 1rem;">';
                  html += title
                  html += '</a>';
                  html += '</div>';
                  html += '</li>';
